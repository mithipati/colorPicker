...
[![Build Status](https://travis-ci.org/mithipati/colorpicker.svg?branch=master)](https://travis-ci.org/mithipati/colorpicker) [![Dependency Status](https://david-dm.org/mithipati/colorpicker.svg)](https://david-dm.org/mithipati/colorpicker) [![devDependency Status](https://david-dm.org/mithipati/colorpicker/dev-status.svg)](https://david-dm.org/mithipati/colorpicker#info=devDependencies)
